...
import com.LG.dao.QuestionDAO;
import com.LG.dao.UserDAO;
import com.LG.model.EntityType;
import com.LG.model.Question;
import com.LG.model.User;
import com.LG.service.FollowService;
import com.LG.service.SensitiveService;
...
public class InitDatabaseTests {
    ...
    public void contextLoads() {
        ...
        for (int i = 0; i < 11; ++i) {
            User user = new User();
            user.setHeadUrl( String.format( "http://images.LG.com/head/%dt.png", random.nextInt( 1000 ) ) );
